 ...
 */
final class Version20220727152223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE images ADD CONSTRAINT FK_E01FBE6A71F7E88B FOREIGN KEY (event_id) REFERENCES post_event (id)');
